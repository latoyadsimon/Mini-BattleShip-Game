//10/01/23 11:45 pm
//10/03/2023
//this is the copy of part 2 that works
//makes a grid, loads ship coordinates, no repeating coordinates in other ships.
//without other optional tasks, project is done
//actually the y/n is not working
//broke the code from here, not working 
//10/03/23 02:08am, code finally working as it should
            ...
            if(ship.includes(userGuess)) {
                ...
                if(ship.length < 1) {
                    ...
                    if(loadedBoard.length < 1) {
                        guessArray = [];
                        let win = rs.keyInYN("You have destroyed all battleships. Would you like to play again?: ", {
