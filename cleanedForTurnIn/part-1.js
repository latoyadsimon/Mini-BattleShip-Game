...
const getLetter = () => {
  ...
  userLetter = rs.question(`Enter a location to strike. `, {
    limitMessage:
      "Choose between a, b, or c else you should admit defeat peasant!",
  });
  return userLetter;
};
...
const getNumber = () => {
  ...
  userNumber = rs.question(`Enter a number. `, {
    limitMessage:
      "Choose between 1, 2, or 3 lest you accept that your garden is overgrown and your cucumbers are soft!!",
  });
  return userNumber;
};
