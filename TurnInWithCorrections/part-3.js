...
const playerGrid = buildGridObj2(gridSize);
...
const makeAGuess = () => {
  ...
  if (guessArray.includes(userGuess)) {
    ...
    guessCtn(userGuess, coord);
  }

  return guessArray;
};

const guessCtn = (userGuess, coord) => {
  let hit = false;
...
const hitStatus = (hit, userGuess, coord) => {
